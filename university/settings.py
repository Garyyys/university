...
from os import environ # читает переменные текущеко окружения
...
SECRET_KEY = 'django-insecure-&^3m$$&t#2^qq$u0k6i!-)1^v0wmfd+ay7*q5ieeofk3$jdy43'
...
DATABASES = {
    'default': {
        ...
        'NAME': environ.get('DATABASE_NAME', 'app'), # подтягивает переменные из енв
